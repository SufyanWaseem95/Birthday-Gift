...
var tsrStartManifest = () => ({ routes: {
	__root__: {
		...
		preloads: ["/assets/index-9AALRhGS.js"],
		scripts: [{ attrs: {
			type: "module",
			async: !0,
			src: "/assets/index-9AALRhGS.js"
		} }]
	},
	"/": {
		...
		preloads: [
			...
			"/assets/camera-BXeKjRgA.js",
			"/assets/rotate-ccw-nwbxEsZC.js",
			"/assets/upload-B9xumZ1j.js"
		]
	},
	"/game": {
